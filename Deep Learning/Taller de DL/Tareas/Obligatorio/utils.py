...
def find_mask_for_image(
    ...
    """
    Dado el path de una imagen, intenta encontrar la máscara correspondiente.
    - Si masks_dir es None, se asume estructura .../train/images y busca en .../train/masks
    - Si valid_exts es None, usa un set común de extensiones de imagen.
    """
    if valid_exts is None:
        valid_exts = [".png", ".jpg", ".jpeg", ".tif", ".tiff", ".bmp"]
    if masks_dir is None:
        # Inferir masks_dir: .../images -> .../masks
