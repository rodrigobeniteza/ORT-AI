"""
Utilidades de visualización y selección de acciones para los notebooks de
**Métodos de Diferencias Temporales** (Sutton & Barto, cap. 6) y
**Planificación Dyna-Q** (cap. 8).
